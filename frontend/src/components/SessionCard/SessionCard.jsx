        ...
        >
            ...
            <Collapse in={expanded}>
                <CardContent sx={{ py: 2, px: 2.5, bgcolor: "#F4F7FF" }}>
                    <Typography sx={{ pl: 0.25, mb: 1, fontWeight: 600, textAlign: 'left' }}>
                        Goals:
                    </Typography>
                    ...
                    <Typography sx={{ pl: 0.25, mb: 1, fontWeight: 600, mt: 2, textAlign: 'left', }}>
                        Estimated time:
                    </Typography>
                    ...
                    >
                        ...
                        >
                            ...
                            <Typography sx={{ fontSize: "0.95rem", fontWeight: 500 }}>
                                {Math.floor(session.duration / 60)} hrs and {session.duration % 60} min
